...
const scoreWords = (word1, word2) => {
  ...
  score +=
    5 *
    scoreSyllables(syllables1[stressedSyl1Pos], syllables2[stressedSyl2Pos]);
  ...
  const ending1 = word1.slice(findStressPosition(word1) + 1);
  const ending2 = word2.slice(findStressPosition(word2) + 1);
